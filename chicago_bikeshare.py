...
answer = "Because there are blank entries in the gender column which are not counted neither as male or female. Therefore, the length of the list is greater than the sum of the entries of male and female."
print("Answer:", answer)
